...
public class user_panel extends AppCompatActivity
    ...
    //text to be displayed of the current user
    ...
    private void goMain() {
        Intent intent = new Intent(user_panel.this, MainActivity.class);
    ...
    private void userLogout() {
        ...
        Intent intent = new Intent(user_panel.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
}
